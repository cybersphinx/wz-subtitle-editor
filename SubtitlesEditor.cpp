	...
	ui(new Ui::MainWindow)
{
	...
	ui->actionStop->setIcon(QIcon::fromTheme("media-playback-stop", style()->standardIcon(QStyle::SP_MediaStop)));
	...
	ui->actionOpen->setIcon(QIcon::fromTheme("document-open", style()->standardIcon(QStyle::SP_DirOpenIcon)));
	ui->actionSave->setIcon(QIcon::fromTheme("document-save", style()->standardIcon(QStyle::SP_DialogSaveButton)));
	ui->actionSaveAs->setIcon(QIcon::fromTheme("document-save-as"));
	ui->actionExit->setIcon(QIcon::fromTheme("application-exit", style()->standardIcon(QStyle::SP_DialogCloseButton)));
	ui->actionAdd->setIcon(QIcon::fromTheme("list-add"));
	ui->actionRemove->setIcon(QIcon::fromTheme("list-remove"));
	ui->actionPrevious->setIcon(QIcon::fromTheme("go-previous"));
	ui->actionNext->setIcon(QIcon::fromTheme("go-next"));
	ui->actionRescale->setIcon(QIcon::fromTheme("chronometer"));
	ui->actionAboutApplication->setIcon(QIcon::fromTheme("help-about"));
